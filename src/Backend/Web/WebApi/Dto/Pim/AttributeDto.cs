...
namespace WebApi.Dto.Pim
{
    public class AttributeDto
    {
        ...
        public AttributeDto(Attribute attribute, bool withCategories = false, bool withPermissions = false)
        {
            Id = attribute.Id;
            Name = attribute.Name;
            Type = attribute.Type;
            ...
            Permissions = withPermissions ?
                attribute.AttributePermissions.Select(ap => new AttributePermissionDto(ap)).ToList()
                : new List<AttributePermissionDto>();
